 ...
 * @var string[]|\Cake\Collection\CollectionInterface $rehabFacilities
 */
?>
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $rehabStay->stay_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $rehabStay->stay_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="rehabStays form content">
            ...
            <fieldset>
                <legend><?= __('Edit Rehab Stay') ?></legend>
                <?php
