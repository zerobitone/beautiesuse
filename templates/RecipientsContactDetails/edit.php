...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $recipientsContactDetail->recipient_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $recipientsContactDetail->recipient_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="recipientsContactDetails form content">
            ...
            <fieldset>
                <legend><?= __('Edit Recipients Contact Detail') ?></legend>
                <?php
