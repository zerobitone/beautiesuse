...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Form->postLink(
                __('Delete'),
                ['action' => 'delete', $rehabFacilitiesLogin->facility_id],
                ['confirm' => __('Are you sure you want to delete # {0}?', $rehabFacilitiesLogin->facility_id), 'class' => 'side-nav-item']
            ) ?>
    ...
    <div class="column column-80">
        <div class="rehabFacilitiesLogin form content">
            ...
            <fieldset>
                <legend><?= __('Edit Rehab Facilities Login') ?></legend>
                <?php
